    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `http://103.159.85.246:6001/api/order/bar-statistics${startDate && endDate
...
//       try {
//         const response = await axios.get(
//           `http://103.159.85.246:6001/api/coupon/coupon/date?startDate=${startDate}&endDate=${endDate}`
//         );

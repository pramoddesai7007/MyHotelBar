...
const Coupon = ({ acPercentage }) => {
  ...
  const handlePrintBill = async () => {
    try {
      const [couponResponse, counterResponse] = await Promise.all([
        axios.get("http://103.159.85.246:6001/api/coupon/coupon/latest"),
        axios.get("http://103.159.85.246:6001/api/counter")
      ]);
  ...
  const handleCounterCoupon = async () => {
    try {
      ...
      const saveCouponResponse = await axios.post(
        "http://103.159.85.246:6001/api/coupon/billCouponOrder",
        saveData
      );
      ...
      const getCouponResponse = await axios.get(
        `http://103.159.85.246:6001/api/coupon/orderNumber/${orderNumber}`
      );
  ...
  useEffect(() => {
    axios
      .get("http://103.159.85.246:6001/api/counter")
      .then((response) => {
    ...
    axios
      .get("http://103.159.85.246:6001/api/table/tables")
      .then((response) => {
  ...
  useEffect(() => {
    if (selectedCategory) {
      axios
        .get(`http://103.159.85.246:6001/api/counter/${selectedCategory._id}`)
        .then((response) => {
  ...
  const printCoupon = async () => {
    try {
      ...
      const countersResponse = await axios.get(
        "http://103.159.85.246:6001/api/counter"
      );
      ...
      const latestCouponResponse = await axios.get(
        "http://103.159.85.246:6001/api/coupon/coupon/latest"
      );

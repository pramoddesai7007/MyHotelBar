...
const CustomerPayment = () => {
  ...
  useEffect(() => {
    axios
      .get("http://103.159.85.246:6001/api/customer/customers")
  ...
  useEffect(() => {
    if (selectedCustomer) {
      axios
        .get(`http://103.159.85.246:6001/api/customer/customers/${selectedCustomer}`)
        .then((response) => {
  ...
  //       `http://103.159.85.246:6001/api/customer/updateBalance/${selectedCustomer}`,
  //       {
  //         debit: debitAmount,
  //       }
  //     );
  ...
  //       `http://103.159.85.246:6001/api/customer/customers/${selectedCustomer}`
  //     );
  ...
  //     await axios.delete(
  //       `http://103.159.85.246:6001/api/customer/customers/${selectedCustomer}/dateWiseRecords/${recordId}`
  //     );
  ...
  const handleDeleteConfirmation = async () => {
    try {
      // Delete the record on the server
      await axios.delete(
        `http://103.159.85.246:6001/api/customer/customers/${selectedCustomer}/dateWiseRecords/${deleteRecordId}`
      );
